...
CREATE TABLE `grit_resource` (
  ...
  `link_tags` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '链接标签(用,隔开)',
  `icon_uri` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '图标地址',
  `remark` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `attrs` varchar(4000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '属性(kv)',
...
CREATE TABLE `grit_subject` (
  ...
  `display_name` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '主体显示名',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='grit-主体分组表';
