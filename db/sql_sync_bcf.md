...
-- bcf.bcf_resource_linked  => grit.grit_resource_linked    
INSERT grit_resource_linked(
resource_id,lk_objt,lk_objt_id
)
SELECT rsid,lk_objt,lk_objt_id
FROM bcf_resource_linked;


-- bcf.bcf_user_linked => grit.grit_user_linked
INSERT grit_user_linked(
user_id,lk_objt,lk_objt_id
)
SELECT puid,lk_objt,lk_objt_id
FROM bcf_user_linked;
